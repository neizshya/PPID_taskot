    ...
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" /dashboard" target="_blank">
                ...
                <span class="ms-1 fs-5">PPID Dashboard</span>
            </a>
        </div>
        ...
        <div class="ps__rail-y" style="top: 0px; height: 902px; right: 0px;">
            <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 893px;"></div>
        </div>
    </aside>
@endsection
