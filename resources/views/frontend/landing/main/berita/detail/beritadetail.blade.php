...
<head>
    ...
    <title>Judul Berita | PPID Kota Tasikmalaya</title>
...
<body>
    ...
    @include('frontend.landing.main.berita.detail.content')
            ...
            <div class="offcanvas offcanvas-end text-bg-light" tabindex="-1" id="navbar"
                ...
                <div class="offcanvas-body">
                    ...
                    <ul class="nav nav-pills flex-column mb-md-0 text-white">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link link-header dropdown-toggle actived rounded-0" href="#"
