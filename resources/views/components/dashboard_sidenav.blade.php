@php
    $dashboard = 'dashboard';
    $caraousel = 'caraousel';
    $input_file = '/url_dashbord';
    $permohonan_informasi = '/url_dashbord';
    $permohonan_keberatan = '/url_dashbord';
    $ppid_pembantu = 'ppid_pembantu_dashboard';
    $jenis_dokumen = 'jenis_dokumen';
    $daftar_info = 'daftar_info';
    $judul_dokumen = 'judul_dokumen';
    $akun = '/url_dashbord';
    $list_akun = 'list_akun';
@endphp
@section('sidenav_dashboard')
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html "
                ...
                <span class="ms-1 font-weight-bold">PPID Dashboard</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse w-auto ps h-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->path() === $caraousel ? 'active' : '' }}" href="/caraousel">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->path() === $input_file ? 'active' : '' }}" href="/input_file">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Input File</span>
                    </a>
                </li>
                @endif
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->path() === $permohonan_informasi ? 'active' : '' }}"
                        ...
                        <span class="nav-link-text ms-1">Permohonan Informasi</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->path() === $permohonan_keberatan ? 'active' : '' }}"
                        ...
                        <span class="nav-link-text ms-1">Permohonan Keberatan</span>
                    </a>
                </li>
                @endif
                @if(Auth::user()->role === 'PU')
                <li class="nav-item">
                    <a class="nav-link {{ request()->path() === $ppid_pembantu ? 'active' : '' }}"
                        ...
                        <span class="nav-link-text ms-1">PPID Pembantu</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->path() === $daftar_info ? 'active' : '' }}" href="/daftar_info">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg class="text-dark" width="16px" height="16px" viewBox="0 0 40 44" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <span class="nav-link-text ms-1">Daftar Informasi Publik</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->path() === $judul_dokumen ? 'active' : '' }}"
                        href="/judul_dokumen">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Judul Dokumen</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->path() === $jenis_dokumen ? 'active' : '' }}"
                        ...
                        <span class="nav-link-text ms-1">Jenis Dokumen</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->path() === $list_akun ? 'active' : '' }}" href="/list_akun">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">List Akun</span>
                    </a>
                </li>
                @endif
                <li class="nav-item">
        ...
        <div class="sidenav-footer mx-3">
            <form action="{{ route('logout') }}" method="POST">
                ...
                <button type="submit" class="btn bg-gradient-primary mt-3 w-100">Keluar</button>
            </form>
        </div>
