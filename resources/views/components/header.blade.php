    ...
    <header
        ...
        <div class="row d-flex justify-content-between">
            ...
            <div class="col-2 text-end d-flex d-xl-none justify-content-end ">
                <button class="navbar-toggler menu-button" type="button" data-bs-toggle="offcanvas" data-bs-target="#navbar"
            ...
            <div class="offcanvas offcanvas-end text-bg-light" tabindex="-1" id="navbar"
                ...
                <div class="offcanvas-body">
                    ...
                    <ul class="nav nav-pills flex-column mb-md-0 text-white">
                        <li class="nav-item"><a href="#" class="nav-link link-header actived rounded-0">Beranda</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link link-header dropdown-toggle" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">PPID Center</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link link-header dropdown-toggle" href="#" role="button"
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu bg-white">
                                <li><a class="dropdown-item text-capitalize" href="#">Permohonan Informasi Online</a>
                                </li>
                                <li><a class="dropdown-item text-capitalize" href="#">permohonan keberatan online</a>
                                </li>
                        ...
                        <li class="nav-item"><a href="#" class="nav-link link-header">E-magazine</a></li>
                        <li><button class="btn btn-primary w-100" data-bs-toggle="modal"
            ...
            <div class="d-none d-xl-flex col-12 col-md-7 mb-2 justify-content-end mb-md-0">
                <ul class=" nav ">
                    <li class="nav-item"><a href="#"
                            class="nav-link px-2 link-header border-dark border-bottom actived">Beranda</a></li>
                    <li class="nav-item dropdown"><a href="#" class="nav-link px-2 link-header">PPID Center</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link link-header dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu bg-white">
                            ...
                            <li><a class="dropdown-item text-capitalize" href="#">DIDP PPID Utama</a></li>
                            <li><a class="dropdown-item text-capitalize" href="#">DIDP PPID Pembantu</a></li>
                            <li><a class="dropdown-item text-capitalize" href="#">DIK PPID Kota Tasikmalaya</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu bg-white">
                            ...
                            <li><a class="dropdown-item text-capitalize" href="#">formulir pelayanan permohonan
                                    informasi
                                    Offline</a></li>
                            <li><a class="dropdown-item text-capitalize" href="#">mekanisme perolehan informasi</a>
                            </li>
                            <li><a class="dropdown-item text-capitalize" href="#">SP4N Lapor</a></li>

                        </ul>
                    </li>
                    <li class="nav-item"><a href="#" class="nav-link px-2 link-header">E-magazine</a></li>
